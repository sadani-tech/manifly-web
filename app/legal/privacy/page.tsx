...
export default function PrivacyPage() {
  return (
    <LegalPage eyebrow="Legal" title="Privacy Policy" effectiveDate={publicConfig.policyVersion}>
      ...
      <section><h2>Retensi dan hakmu</h2><p>Data akun disimpan selama akun aktif. Log keamanan dan bukti transaksi/billing dapat disimpan lebih lama untuk audit, sengketa, pajak, atau kewajiban hukum. Kamu dapat meminta akses, koreksi, ekspor, atau penghapusan melalui halaman Data Deletion. Opt-in WhatsApp dapat dicabut dari Settings atau dengan melepaskan nomor.</p></section>
    </LegalPage>
  );
}
