...
export default function SmartRulesPage() {
  ...
  useEffect(() => { void load(); }, []);
  return <div className="space-y-6"><div><p className="text-xs font-bold uppercase tracking-widest text-kicker">Beres otomatis</p><h2 className="mt-1 text-3xl font-black">Smart Rules</h2><p className="text-sm text-muted-foreground">Periksa dulu, lalu terapkan. Perubahan masih bisa dibatalkan selama tujuh hari.</p></div>
